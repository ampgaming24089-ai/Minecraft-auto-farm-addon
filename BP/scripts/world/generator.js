 ...
 * End Ascendant generates them just ahead of the player instead: a scan every two
  ...
  try {
    ...
    if (plan.warden) {
      try {
        ...
        console.warn(`[End Ascendant] could not place the Warden at ${site.key}: ${error}`);
      }
      yield;
    }
    ...
    if (plan.boss) {
      try {
        ...
        console.warn(`[End Ascendant] could not place the Sovereign at ${site.key}: ${error}`);
      }
      yield;
    }
    ...
    if (plan.titan) {
      ...
      try {
        ...
        console.warn(`[End Ascendant] could not place the Titan at ${site.key}: ${error}`);
      }
      yield;
    }
    ...
    console.warn(`[End Ascendant] build failed at ${site.key}: ${error}`);
